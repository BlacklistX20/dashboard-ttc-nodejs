...
const realTimeData = async () => {
   ...
   let pRecti = sum(parseFloat(p205.data.p), parseFloat(p236.data.p), parseFloat(p305.data.p305), parseFloat(p305.data.p310), parseFloat(p429.data.p));
   let iRecti = sum(parseFloat(p205.data.i), parseFloat(p236.data.i), parseFloat(p305.data.i305), parseFloat(p305.data.i310), parseFloat(p429.data.i));
   let vRecti = avg(parseFloat(p205.data.v), parseFloat(p236.data.v), parseFloat(p305.data.v305), parseFloat(p305.data.v310), parseFloat(p429.data.v));
   let fRecti = avg(parseFloat(p205.data.f), parseFloat(p236.data.f), parseFloat(p305.data.f305), parseFloat(p305.data.f310), parseFloat(p429.data.f));
   ...
   electric.query("UPDATE real_time SET last_update = '" + update + "', loads = " + p305.data.p310 + ", current = " + p305.data.i310 + ", voltage = " + p305.data.v310 + ", frequency = " + p305.data.f310 + " WHERE id = 9", function (err, result) {
      if (err) console.log(err);
   });
